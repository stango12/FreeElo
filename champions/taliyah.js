...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/163/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/163/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/163/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/163/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/163/MIDDLEmasteryMax.txt");
};
