...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/203/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/203/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/203/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/203/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/203/JUNGLEmasteryMax.txt");
};
