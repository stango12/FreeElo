...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/18/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/18/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/18/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/18/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/18/BOTTOMmasteryMax.txt");
};
