...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/4/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/4/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/4/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/4/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/4/MIDDLEmasteryMax.txt");
};
