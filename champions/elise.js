...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/60/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/60/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/60/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/60/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/60/JUNGLEmasteryMax.txt");
};
