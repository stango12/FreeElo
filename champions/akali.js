...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/91/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/91/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/91/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/91/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/91/MIDDLEmasteryMax.txt");
};
