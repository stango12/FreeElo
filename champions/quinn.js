...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/133/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/133/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/133/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/133/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/133/TOPmasteryMax.txt");
};
