...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/1/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/1/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/1/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/1/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/1/MIDDLEmasteryMax.txt");
};
