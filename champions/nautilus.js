...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/111/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/111/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/111/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/111/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/111/BOTTOMmasteryMax.txt");
};
