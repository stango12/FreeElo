...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/412/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/412/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/412/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/412/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/412/BOTTOMmasteryMax.txt");
};
