...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/85/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/85/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/85/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/85/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/85/TOPmasteryMax.txt");
};
