...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/34/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/34/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/34/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/34/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/34/MIDDLEmasteryMax.txt");
};
