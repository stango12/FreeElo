...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/30/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/30/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/30/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/30/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/30/MIDDLEmasteryMax.txt");
};
