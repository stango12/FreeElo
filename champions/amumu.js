...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/32/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/32/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/32/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/32/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/32/JUNGLEmasteryMax.txt");
};
