...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/59/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/59/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/59/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/59/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/59/JUNGLEmasteryMax.txt");
};
