...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/5/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/5/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/5/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/5/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/5/JUNGLEmasteryMax.txt");
};
