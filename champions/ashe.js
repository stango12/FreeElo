...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/22/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/22/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/22/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/22/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/22/BOTTOMmasteryMax.txt");
};
