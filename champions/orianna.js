...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/61/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/61/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/61/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/61/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/61/MIDDLEmasteryMax.txt");
};
