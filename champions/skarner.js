...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/72/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/72/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/72/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/72/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/72/JUNGLEmasteryMax.txt");
};
