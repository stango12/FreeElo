...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/120/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/120/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/120/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/120/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/120/JUNGLEmasteryMax.txt");
};
