...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/202/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/202/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/202/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/202/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/202/BOTTOMmasteryMax.txt");
};
