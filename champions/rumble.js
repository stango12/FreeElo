...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/68/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/68/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/68/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/68/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/68/TOPmasteryMax.txt");
};
