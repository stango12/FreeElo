...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/143/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/143/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/143/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/143/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/143/BOTTOMmasteryMax.txt");
};
