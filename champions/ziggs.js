...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/115/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/115/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/115/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/115/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/115/MIDDLEmasteryMax.txt");
};
