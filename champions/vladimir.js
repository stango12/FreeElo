...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/8/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/8/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/8/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/8/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/8/MIDDLEmasteryMax.txt");
};
