...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/223/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/223/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/223/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/223/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/223/BOTTOMmasteryMax.txt");
};
