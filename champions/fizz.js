...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/105/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/105/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/105/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/105/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/105/MIDDLEmasteryMax.txt");
};
