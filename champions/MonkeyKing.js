...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/62/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/62/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/62/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/62/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/62/TOPmasteryMax.txt");
};
