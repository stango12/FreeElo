...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/121/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/121/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/121/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/121/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/121/JUNGLEmasteryMax.txt");
};
