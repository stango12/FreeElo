...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/254/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/254/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/254/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/254/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/254/JUNGLEmasteryMax.txt");
};
