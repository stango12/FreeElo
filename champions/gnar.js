...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/150/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/150/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/150/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/150/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/150/TOPmasteryMax.txt");
};
