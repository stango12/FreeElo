...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/45/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/45/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/45/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/45/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/45/MIDDLEmasteryMax.txt");
};
