...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/432/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/432/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/432/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/432/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/432/BOTTOMmasteryMax.txt");
};
