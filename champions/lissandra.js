...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/127/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/127/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/127/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/127/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/127/MIDDLEmasteryMax.txt");
};
