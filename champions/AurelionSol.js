...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/136/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/136/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/136/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/136/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/136/MIDDLEmasteryMax.txt");
};
