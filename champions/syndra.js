...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/134/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/134/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/134/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/134/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/134/MIDDLEmasteryMax.txt");
};
