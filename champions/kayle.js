...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/10/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/10/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/10/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/10/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/10/TOPmasteryMax.txt");
};
