...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/29/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/29/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/29/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/29/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/29/BOTTOMmasteryMax.txt");
};
