...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/420/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/420/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/420/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/420/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/420/TOPmasteryMax.txt");
};
