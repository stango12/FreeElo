...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/110/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/110/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/110/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/110/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/110/BOTTOMmasteryMax.txt");
};
