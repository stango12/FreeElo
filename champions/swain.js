...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/50/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/50/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/50/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/50/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/50/TOPmasteryMax.txt");
};
