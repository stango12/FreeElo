...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/201/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/201/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/201/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/201/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/201/BOTTOMmasteryMax.txt");
};
