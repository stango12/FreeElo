...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/2222/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/2222/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/2222/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/2222/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/2222/BOTTOMmasteryMax.txt");
};
            ...
            if(rawFile.status === 200 || rawFile.status == 0)
            {
                ...
                for(i = 0; i < idArray.length; i += 2)
                {
                    if(idArray[i] != "")
                    {
                        ...
                        var runeId = httpGet("https://global.api.pvp.net/api/lol/static-data/na/v1.2/rune/" + idArray[i] + "?runeData=image&api_key=491b6446-c673-4e8a-a877-2568ad964a6a");
