...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/3/MIDDLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/3/MIDDLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/3/MIDDLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/3/MIDDLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/3/MIDDLEmasteryMax.txt");
};
