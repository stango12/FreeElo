...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/89/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/89/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/89/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/89/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/89/BOTTOMmasteryMax.txt");
};
