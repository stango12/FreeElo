...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/11/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/11/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/11/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/11/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/11/JUNGLEmasteryMax.txt");
};
