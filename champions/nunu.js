...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/20/JUNGLEstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/20/JUNGLEendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/20/JUNGLEspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/20/JUNGLErunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/20/JUNGLEmasteryMax.txt");
};
