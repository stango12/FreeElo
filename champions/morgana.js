...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/25/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/25/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/25/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/25/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/25/BOTTOMmasteryMax.txt");
};
