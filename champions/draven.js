...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/119/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/119/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/119/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/119/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/119/BOTTOMmasteryMax.txt");
};
