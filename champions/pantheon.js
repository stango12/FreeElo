...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/80/TOPstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/80/TOPendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/80/TOPspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/80/TOPrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/80/TOPmasteryMax.txt");
};
