...
var main = function() {
 ...
 //    fileDisplayArea.innerText = "test"; 
    readTextFileStart("http://localhost:8000/champions/data/117/BOTTOMstartMax.txt");
    readTextFileEnd("http://localhost:8000/champions/data/117/BOTTOMendMax.txt");
    readTextFileSpells("http://localhost:8000/champions/data/117/BOTTOMspellMax.txt");
    readTextFileRunes("http://localhost:8000/champions/data/117/BOTTOMrunesMax.txt");
    readTextFileMastery("http://localhost:8000/champions/data/117/BOTTOMmasteryMax.txt");
};
